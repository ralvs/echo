...
server.registerTool(
  "capture_thought",
  {
    ...
    description:
      "Save a new thought to Echo. Generates an embedding and extracts metadata automatically. Use this when the user wants to save something — notes, insights, decisions, or migrated content from other systems.",
    inputSchema: {
